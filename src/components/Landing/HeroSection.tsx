...
import { ArrowRight, Check, Bookmark } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <motion.div
                    ...
                    className="relative">
                    <div className="relative bg-gray-50 dark:bg-gray-900 rounded-3xl p-8 border border-gray-200 dark:border-gray-800 shadow-2xl transition-colors duration-300">
                        <div className="space-y-4">
                            <motion.div
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: 0.5 }}
                                className="bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 className="font-semibold text-gray-900 dark:text-white mb-1 transition-colors duration-300">Understanding React Hooks</h3>
                                        <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2 transition-colors duration-300">Complete guide to modern React development</p>
                                        <div className="flex items-center gap-2 mt-3">
                                            <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-md text-xs transition-colors duration-300">react</span>
                                            <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-md text-xs transition-colors duration-300">tutorial</span>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-2 mt-3">
                                            <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-md text-xs transition-colors duration-300">
                                                design</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <motion.div
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 className="font-semibold text-gray-900 dark:text-white mb-1 transition-colors duration-300">Productivity Tips Article</h3>
                                        <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2 transition-colors duration-300">How to stay focused in 2024</p>
                                        <div className="flex items-center gap-2 mt-3">
                                            <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-md text-xs transition-colors duration-300">productivity</span>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        <motion.div
                            ...
                            className="absolute -top-4 -right-4 bg-white dark:bg-gray-800 px-5 py-3 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 transition-colors duration-300">
                            <div className="flex items-center gap-2">
