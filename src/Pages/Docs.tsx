...
import CardOutline from "@/components/CardOutilne";
...
export default function Docs() {
  ...
  return (
    <div className="my-24 flex flex-col items-start gap-5 text-start">
      <div className="flex w-170 flex-col">
        <div className="flex flex-col gap-3">
          <div className="flex w-fit items-center gap-1 rounded-sm border border-zinc-500 bg-zinc-200 px-2 py-1 text-xs text-zinc-600">
          ...
          <p>
            ...
            workers who save hundreds of links. Powered by instant search, smart
            tags, and category-based organisation — so you never lose track of
            what matters.
          </p>
        </div>
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={cn(
                          colors[idx % colors.length].light,
                          colors[idx % colors.length].dark,
                          "rounded border p-1 font-medium",
                        )}
                      >
                        <x.icon size={14} />
                      </span>
      ...
      <div className="flex flex-col gap-2 text-sm">
        ...
        <div className="my-1 flex gap-3">
          ...
          {[
            { title: "Email support", icon: MailIcon, link: "" },
            { title: "View on Github", icon: GithubIcon, link: "" },
            { title: "Help", icon: HelpCircle, link: "" },
          ].map((x, idx) => {
            return (
              <a
